		...
		<section className="flex items-center lg:justify-center bg-transparent my-24" id="home" style={{ height: '90vh' }}>
			<div className="lg:flex sm:flex-row z-40 items-center">
				<div className="z-10 lg:mx-20 mx-10">
					...
					<a href="#djed_apps" onClick={(e) => { e.preventDefault(); document.getElementById('djed_apps')?.scrollIntoView({ behavior: 'smooth' }); }} className="link-text w-64 flex items-center justify-center py-3 text-base font-medium text-center text-white bg-black rounded-full cursor-pointer">
						Get started
